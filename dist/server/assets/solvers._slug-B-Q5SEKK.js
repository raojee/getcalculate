...
import { R as Route } from "./router-BBBvb1MH.js";
import "framer-motion";
import "@tanstack/react-router";
const GeometrySolver = lazy(() => import("./GeometrySolver-Bkt3VL28.js"));
const StatisticsCalculator = lazy(() => import("./StatisticsCalculator-D5P0PDQq.js"));
const GraphPlotter = lazy(() => import("./GraphPlotter-BRIgV2Sa.js"));
function SolverPageComponent() {
  ...
  const renderSolver = () => {
    return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsxs("div", { className: "h-[500px] flex flex-col items-center justify-center glass rounded-[2.5rem] border-dashed border-white/5 bg-white/[0.01]", children: [
      /* @__PURE__ */ jsx(Loader2, { className: "w-10 h-10 text-amber animate-spin opacity-40 mb-4" }),
      /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-muted opacity-40", children: "Initializing Engine..." })
    ] }), children: (() => {
      switch (solver.type) {
        case "geometry":
